...
import { CONTRACT_ABI, INVI_RABBIT_ABI } from "./abi";
...
const NFT_CONTRACT_ABI = INVI_RABBIT_ABI
const NFT_CONTRACT_ADDRESS = "0xd1f0Ba7fc9f0ca737Df9C6479536c355812CF9ED"
...
async function main() {
    ...
    const nft = {
        ...
        maxPerTx: 30,// parseInt(ethers.utils.formatUnits(await nftContract.MAX_MINT_COUNT(), 0))
    }
