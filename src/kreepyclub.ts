...
import { CONTRACT_ABI, KREEPY_CLUB_ABI } from "./abi";
...
const NFT_CONTRACT_ADDRESS = "0xBBa205283253E7aDB8Be4A0b03600c9AB4924974"
...
async function main() {
    ...
    const nftContract = new Contract(NFT_CONTRACT_ADDRESS, KREEPY_CLUB_ABI, wallet);
